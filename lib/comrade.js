(function() {
  ...
  Comrade = (function() {
    ...
    Comrade.prototype.start = function() {
      this.i = readline.createInterface(this.inStream, this.outStream, __bind(function(line) {
        return this.complete(line);
      }, this));
      this.i.on('line', __bind(function() {
        var args;
        args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return this.processLine.apply(this, args);
      }, this));
      this.i.on('SIGINT', __bind(function() {
        return this.processSigint();
      }, this));
      this.i.on('attemptClose', __bind(function() {
        return this.processAttemptClose();
      }, this));
      return this.prompt();
    };
    Comrade.prototype.safeOutput = function(doOutput) {
      this.i.output.clearLine();
      this.i.output.cursorTo(0);
      doOutput();
      return this.i._refreshLine();
    };
    ...
    Comrade.prototype.prompt = function() {
      this.i.setPrompt(this.renderPrompt(this.currentMode));
      return this.i.prompt();
    };
